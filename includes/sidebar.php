...
<?php if (isset ($_SESSION['user_role'])) : ?>
                <div class="well">
                   ...
                   <a class="btn btn-warning" href="<?php echo $home_url; ?>/includes/logout.php">Log Out</a> 
                </div>
<?php else: ?>
                <div class="collapse panel panel-primary" id="collapseLogin">
                <div class="panel-heading"><a class="btn-primary" href="<?php echo $home_url; ?>/login"> Log In </a></div> 
...
while (mysqli_stmt_fetch ($stmt)) {
    echo "<li><a href='{$home_url}/category.php?category={$cat_id}'>{$cat_title}</a></li>";
}
